...
export default function TeacherPage() {
  ...
  // Dummy signOut function for demonstration; replace with your auth logic
...
// setLoading is a state setter for loading, so it should use React's useState.
// Place this at the top of your component, before any usage of setLoading:

// (Moved useState for loading to the top of the component)
